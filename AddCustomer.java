...
//        lbladharNumber.setBounds(60,200,150,25);
//       lbladharNumber.setFont(new Font("Tahoma",Font.PLAIN,16));
//      add(lbladharNumber);
//      
//        
//      JTextField tfadharnumber = new JTextField();
//      tfadharnumber.setBounds(220,200,150,25);
//        add(tfadharnumber);
//        
//        // ADDRESS
//        
...
//       lblphone.setBounds(60,390,150,25);
//      lblphone.setFont(new Font("Tahoma",Font.PLAIN,16));
//      add(lblphone);
//        
//       tfphone = new JTextField();
//     tfphone.setBounds(220,390,150,25);
//        add(tfphone);
//        
//        // SAVE
//        
...
//        save.setBounds(150,460,130,25);
//        save.addActionListener(this);
//     add(save);
//        
//       // EMP IMAGE
//        ImageIcon image =new ImageIcon(ClassLoader.getSystemResource("pushpak/viman/icons/emp.png"));
//        JLabel lblimage = new JLabel(image);
//        lblimage.setBounds(450,80,280,410);
//        add(lblimage);
//        
//        
//        setSize(900,600);
